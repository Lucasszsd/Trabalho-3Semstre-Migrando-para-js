...
CONSTRAINT PRIMARY KEY(codeditora)
...
CONSTRAINT  PRIMARY KEY(codlivro),
CONSTRAINT  FOREIGN KEY(codeditora) REFERENCES EDITORA(codeditora),
CONSTRAINT  FOREIGN KEY(sigla) REFERENCES ASSUNTO(sigla)
...
CONSTRAINT  FOREIGN KEY(codlivro) REFERENCES LIVRO(codlivro),
...
CREATE TABLE CARTAO(
        ...
        CONSTRAINT  primary key(codcartao)
...
CONSTRAINT  FOREIGN KEY(codcartao) REFERENCES CARTÃO(codcartao)
...
codlivro decimal(10),
cpf decimal(10) NOT NULL,
CONSTRAINT  PRIMARY KEY(idvenda, codlivro),
CONSTRAINT  FOREIGN KEY(codlivro) REFERENCES LIVRO(codlivro),
CONSTRAINT  FOREIGN KEY(cnpj) REFERENCES LOJA(cnpj),
...
INSERT INTO VENDA(idvenda, quantidade, total, datavenda, cnpj, codlivro, cpf) VALUES(15,8,320.000,'2022-10-12',99992,5,890106);
...
INSERT INTO VENDA(idvenda, quantidade, total, datavenda, cnpj, codlivro, cpf) VALUES(17,1,252.30,'2022-10-12',99992,5,890006);
...
INSERT INTO VENDA(idvenda, quantidade, total, datavenda, cnpj, codlivro, cpf) VALUES(21,1,150.00,'2021-08-26',99992,5,890706);
